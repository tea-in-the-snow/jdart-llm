...
async def solve(req: SolveRequest):
    ...
    system_instructions = (
        ...
        "2. For type constraints (instanceof), assign the reference variable appropriately:\n"
        ...
        "3. Build upon the base valuation if provided, extending or modifying it as needed to satisfy all constraints.\n\n"
        "4. Output format: Respond ONLY with valid JSON, no additional text. Use one of these formats:\n"
        ...
        "   - {\"result\":\"UNSAT\"} when constraints are unsatisfiable\n"
        "   - {\"result\":\"UNKNOWN\", \"raw\": \"explanation\"} when you cannot determine satisfiability\n\n"
        "5. The valuation array should contain objects with FLAT keys using dot notation (e.g., \"obj.__ref\", \"x.field\") mapping to their values.\n"
